...
export default /*public*/ class ByteArrayOutputStream extends OutputStream {
   ...
   */
    public /*synchronized*/ write(b: number): void {
   ...
   */
    public /*synchronized*/  writeBytesOffset(b: Uint8Array, off: number, len: number): void {
   ...
   */
    public /*synchronized*/ size(): number {
    return this.count;
  }
  ...
  toString(param?: number | string) {
    ...
    if (typeof param === 'string') {
        ...
        return this.toString_string();
    }
      //return this.toString_number(param);
      return this.toString_number();
  }
