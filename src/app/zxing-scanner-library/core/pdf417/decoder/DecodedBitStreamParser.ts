...
export default /*final*/ class DecodedBitStreamParser {
    ...
    private static /*final*/ TEXT_COMPACTION_MODE_LATCH: number = 900;
    private static /*final*/ BYTE_COMPACTION_MODE_LATCH: number = 901;
    private static /*final*/ NUMERIC_COMPACTION_MODE_LATCH: number = 902;
    private static /*final*/ BYTE_COMPACTION_MODE_LATCH_6: number = 924;
    private static /*final*/ ECI_USER_DEFINED: number = 925;
    private static /*final*/ ECI_GENERAL_PURPOSE: number = 926;
    private static /*final*/ ECI_CHARSET: number = 927;
    private static /*final*/ BEGIN_MACRO_PDF417_CONTROL_BLOCK: number = 928;
    private static /*final*/ BEGIN_MACRO_PDF417_OPTIONAL_FIELD: number = 923;
    private static /*final*/ MACRO_PDF417_TERMINATOR: number = 922;
    private static /*final*/ MODE_SHIFT_TO_BYTE_COMPACTION_MODE: number = 913;
    private static /*final*/ MAX_NUMERIC_CODEWORDS: number = 15;

    private static /*final*/ MACRO_PDF417_OPTIONAL_FIELD_FILE_NAME: number = 0;
    private static /*final*/ MACRO_PDF417_OPTIONAL_FIELD_SEGMENT_COUNT: number = 1;
    private static /*final*/ MACRO_PDF417_OPTIONAL_FIELD_TIME_STAMP: number = 2;
    private static /*final*/ MACRO_PDF417_OPTIONAL_FIELD_SENDER: number = 3;
    private static /*final*/ MACRO_PDF417_OPTIONAL_FIELD_ADDRESSEE: number = 4;
    private static /*final*/ MACRO_PDF417_OPTIONAL_FIELD_FILE_SIZE: number = 5;
    private static /*final*/ MACRO_PDF417_OPTIONAL_FIELD_CHECKSUM: number = 6;

    private static /*final*/ PL: number = 25;
    private static /*final*/ LL: number = 27;
    private static /*final*/ AS: number = 27;
    private static /*final*/ ML: number = 28;
    private static /*final*/ AL: number = 28;
    private static /*final*/ PS: number = 29;
    private static /*final*/ PAL: number = 29;
   ...
   */
  private static /*final*/ EXP900: BigInteger[] = getEXP900();

    private static /*final*/ NUMBER_OF_SEQUENCE_CODEWORDS: number = 2;
  ...
  static decode(codewords: Int32Array, ecLevel: string): DecoderResult {
    ...
    // Get compaction mode
      ...
      let code: number = codewords[codeIndex++];
   ...
   */
    ...
    static decodeMacroBlock(codewords: Int32Array, codeIndex: number, resultMetadata: PDF417ResultMetadata): number {
    ...
    resultMetadata.setSegmentIndex(Integer.parseInt(DecodedBitStreamParser.decodeBase900toBase10(segmentIndexArray,
      DecodedBitStreamParser.NUMBER_OF_SEQUENCE_CODEWORDS), null));
    ...
    resultMetadata.setFileId(fileId.toString());
        ...
        let optionalFieldsStart: number = -1;
        ...
        case DecodedBitStreamParser.BEGIN_MACRO_PDF417_OPTIONAL_FIELD:
          ...
          switch (codewords[codeIndex]) {
            ...
            case DecodedBitStreamParser.MACRO_PDF417_OPTIONAL_FIELD_SEGMENT_COUNT:
              ...
              resultMetadata.setSegmentCount(Integer.parseInt(segmentCount.toString(), null));
              break;
            case DecodedBitStreamParser.MACRO_PDF417_OPTIONAL_FIELD_TIME_STAMP:
              ...
              resultMetadata.setTimestamp(Long.parseLong(timestamp.toString(), null));
              break;
            case DecodedBitStreamParser.MACRO_PDF417_OPTIONAL_FIELD_CHECKSUM:
              ...
              resultMetadata.setChecksum(Integer.parseInt(checksum.toString(), null));
              break;
            case DecodedBitStreamParser.MACRO_PDF417_OPTIONAL_FIELD_FILE_SIZE:
              ...
              resultMetadata.setFileSize(Long.parseLong(fileSize.toString(), null));
              break;
            default:
              throw FormatException.getFormatInstance();
          }
    ...
    if (optionalFieldsStart !== -1) {
        let optionalFieldsLength: number = codeIndex - optionalFieldsStart;
   ...
   */
    private static textCompaction(codewords: Int32Array, codeIndex: number, result: StringBuilder): number {
  ...
  private static decodeTextCompaction(textCompactionData: Int32Array,
    ...
    let priorToShiftMode: Mode = Mode.ALPHA;
      let i: number = 0;
    while (i < length) {
        let subModeCh: number = textCompactionData[i];
      let ch: /*char*/ string = '';
      switch (subMode) {
        case Mode.ALPHA:
   ...
   * @return The next index into the codeword array.
   */
    private static /*int*/ byteCompaction(mode: number,
    ...
    switch (mode) {
      case DecodedBitStreamParser.BYTE_COMPACTION_MODE_LATCH:
        ...
        let byteCompactedCodewords: Int32Array = new Int32Array(6);
            let nextCode: number = codewords[codeIndex++];
        while ((codeIndex < codewords[0]) && !end) {
   ...
   * @throws FormatException
   */
    private static numericCompaction(codewords: Int32Array, codeIndex: number /*int*/, result: StringBuilder): number {
        let count: number = 0;
    let end: boolean = false;
   ...
   * @throws FormatException
   */
    private static decodeBase900toBase10(codewords: Int32Array, count: number): string {
