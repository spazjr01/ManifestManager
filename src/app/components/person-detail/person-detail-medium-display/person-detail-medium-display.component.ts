...
@Component({
  selector: 'app-person-detail-medium-display',
  templateUrl: './person-detail-medium-display.component.html',
  styleUrls: ['./person-detail-medium-display.component.scss'],
})

export class PersonDetailMediumDisplayComponent extends PersonDetailSharedComponent {
