...
@Component({
  selector: 'app-manifest-detail-small-display',
  templateUrl: './manifest-detail-small-display.component.html',
  styleUrls: ['./manifest-detail-small-display.component.scss'],
})
export class ManifestDetailSmallDisplayComponent extends ManifestDetailSharedComponent {
